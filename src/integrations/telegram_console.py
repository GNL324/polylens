...
from src.integrations.telegram_time import DEFAULT_TELEGRAM_TZ, format_local_timestamp
...
def format_local_time(dt: datetime) -> str:
    ...
    return format_local_timestamp(dt, tz=TIMEZONE)
