...
.q-page:has(.mc-shell),
.q-layout:has(.mc-shell),
.q-page-container:has(.mc-shell) {
  width: 100% !important;
  max-width: none !important;
}
...
.mc-shell {
  ...
  min-height: 100vh;
  margin: 0;
  padding: 20px clamp(16px, 2.5vw, 42px) 34px;
  display: flex;
...
@media (max-width: 1200px) {
  ...
  .mc-overview-grid .mc-span-8,
  .mc-overview-grid .mc-span-4 {
    grid-column: span 6;
  }
